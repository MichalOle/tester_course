...
public class RandomNumberTwoMethods {

    public void maximum(ArrayList<Integer> randomlist){
        int max = Collections.max(randomlist);
        System.out.println("Najwiekszy element kolekcji wynosi "+ max);

    }
    public void minimum(ArrayList<Integer> randomlist){
...
//                System.out.println("Najwiekszyasdasd element kolekcji wynosi "+ max);
//                System.out.println("Najmniejszy element kolekcji wynosi "+ min);
        ...
        RandomNumberTwoMethods randomNumberTwoMethods = new RandomNumberTwoMethods();
        randomNumberTwoMethods.maximum(losy);
        randomNumberTwoMethods.minimum(losy);
